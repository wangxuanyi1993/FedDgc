...
# 获取文件某一列数据
with open("../result/FedDgc_cifar10_unbalance_noiid_nowarm_50.csv") as data:
...
with open("../result/FedDgc_cifar10_unbalance_noiid_nowarm_150.csv") as data:
    reader = csv.reader(data)
    header = next(reader)
    fedDgc_acc_150 = []
    fedDgc_loss_150 = []
...
with open("../result/FedDgc_cifar10_unbalance_noiid_nowarm_200.csv") as data:
    reader = csv.reader(data)
    header = next(reader)
    fedDgc_acc_200 = []
    fedDgc_loss_200 = []
...
with open("../result/FedDgc_cifar10_unbalance_noiid_nowarm_300.csv") as data:
    reader = csv.reader(data)
    header = next(reader)
    fedDgc_acc_300 = []
    fedDgc_loss_300 = []
...
# plt.savefig('../pic/cifar10_speed_add150', dpi=300)
# plt.savefig('../pic_zh/cifar10_speed_add150', dpi=300)
plt.show()
